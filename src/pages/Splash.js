...
const Splash = ({ history }) => {
    return (
        <Layout headerNone footerNone={true}>
            <section style={{minHeight: '100vh', position: 'relative', backgroundColor: '#000', overflow: 'hidden', padding: '30px 35px'}} >
                <p onClick={() => history.push('/secure')} style={{color: "#18A0FB", margin: 0, textAlign: 'right', cursor: 'pointer'}}>개인정보처리방침</p>
                <section style={{height: '88vh'}} className="flex flex-col justify-between">
