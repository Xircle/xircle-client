          ...
          <nav>
              <ul className="flex flex-row ">
                  ...
                  <li className="text-2xl font-bold mx-5 text-white">
                    <button onClick={() => setClicked(true)} className="font-sans text-white px-3 py-10 text-2xl font-bold  rounded-xl bg-transparent-600 border-2 hover:bg-white hover:text-black focus:outline-none">로그인</button>
                  </li>
              </ul>
          </nav>
      </header>
