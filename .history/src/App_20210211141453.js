          ...
          <nav>
              <ul className="flex flex-row items-center ">
                  ...
                  <li className="text-xl font-bold mx-3 text-white">
                    <button onClick={() => setClicked(true)} className="font-sans text-white px-5 py-3 rounded-xl bg-transparent-600 t border-2 hover:bg-white hover:text-black focus:outline-none">로그인</button>
                  </li>
              </ul>
          </nav>
      </header>
