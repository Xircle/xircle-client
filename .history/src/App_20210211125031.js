        ...
        <section className="h-screen">
          ...
          >
            <div className="flex flex-col items-center w-full h-full" style={{backgroundColor: 'rgba(0, 0, 0, 0.4)'}}>
              ...
              <button onClick={() => setClicked(true)} className="font-sans text-white w-48 h-16 mt-10 rounded-3xl bg-transparent-600 border-2 hover:bg-white hover:text-red focus:outline-none">계정 만들기</button>
            </div>
          </div>
        </section>
      </Layout>
