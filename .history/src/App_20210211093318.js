    ...
    <>
      <Layout>
        ...
        <section className="h-screen">
          ...
          >
            <div className="flex flex-col justify-center w-full h-full" style={{backgroundColor: 'rgba(0, 0, 0, 0.4)'}}>
              ...
              <button className="text-red-600 w-48 h-16 rounded-3xl bg-gray-300">계정 만들기</button>
            </div>
          </div>
        </section>
