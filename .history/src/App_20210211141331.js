...
const App = () => {
  ...
  return (
    <>
      {/* Header */}
      <header className="absolute w-full flex flex-row justify-between items-center px-5 py-7">
          <h1 className="text-3xl font-bold text-white">연고링</h1>
          <nav>
              <ul className="flex flex-row items-center ">
                  <li className="text-xl font-bold mx-5 text-white">사용법</li>
                  <li className="text-xl font-bold mx-5 text-white">
                    <button onClick={() => setClicked(true)} className="font-sans text-white px-5 py-3 rounded-xl bg-transparent-600 border-2 hover:bg-white hover:text-black focus:outline-none">로그인</button>
                  </li>
              </ul>
          </nav>
      </header>
