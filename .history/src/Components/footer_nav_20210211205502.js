...
const footer_nav = () => {
    ...
    return (
        ...
        >
            ...
            <NavLink to="love-me">
                <img 
                    src={(window.location.pathname == "/love-me") ? "NavImage/love-me.svg" : "NavImage/love-me-outline.svg"}
                    width={35}
                    height={35}
                />
            </NavLink>
            <NavLink to="/profile">
                <img 
                    src={(window.location.pathname == "/profile") ? "NavImage/profile.svg" : "NavImage/person-outline.svg"}
                    width={35}
                    height={35}
                />
            </NavLink>
