      ...
      <Layout>
        <section className="h-screen">
          <Modal show={isclicked} clicked={() => setClicked(false)}>
            ...
            <div>
              <button onClick={() => console.log('clicked')} className="font-sans w-full border-2 rounded-3xl px-5 py-3 mt-10 hover:text-white hover:bg-black focus:border-none">학교 이메일로 인증하기</button>
            </div>
          </Modal>
          <div 
            style={{
