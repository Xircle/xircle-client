      ...
      <header className="absolute w-full flex flex-row justify-between px-10 py-7">
          ...
          <nav>
              <ul className="flex flex-row ">
                  ...
                  <button onClick={() => setClicked(true)} className="font-sans text-white w-20 h-20 text-2xl font-bold mx- rounded-xl bg-transparent-600 border-2 hover:bg-white hover:text-black focus:outline-none">로그인</button>
              </ul>
          </nav>
      </header>
