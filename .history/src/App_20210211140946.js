...
const App = () => {
  ...
  return (
    <>
      {/* Header */}
      <header className="absolute w-full flex flex-row justify-between px-10 py-7">
          <h1 className="text-3xl font-bold text-white align-middle">연고링</h1>
          <nav>
              <ul className="flex flex-row ">
                  <li className="text-2xl font-bold mx-5 text-white align-middle">사용법</li>
                  <li className="text-2xl font-bold mx-5 text-white">
                    <button onClick={() => setClicked(true)} className="font-sans text-white px-3 py-3 text-2xl font-bold  rounded-xl bg-transparent-600 border-2 hover:bg-white hover:text-black focus:outline-none">로그인</button>
                  </li>
              </ul>
          </nav>
      </header>
